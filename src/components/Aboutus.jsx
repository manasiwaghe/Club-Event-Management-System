  ...
  return (
    <>
      ...
      <div className="bg-[#222847]/65 w-3/5 h-4/5 text-center rounded-3xl p-16">
        ...
        <h4 className="text-[#B6BBC4] pt-10 pb-10 px-16">The overwhelming amount of events going on in our college can sometimes be confusing. We at Clubsync are here to help you. Our website is a one-stop page for all the clubs and their activities so that you never miss out on anything! From technical to cultural we host the information of all clubs and events that take place on our campus. To make sure that students stay updated at all times we hope to give you a great experience. In Case you face any difficulties feel free to reach out via the Contact Us section.</h4>
      </div>
      </div>
